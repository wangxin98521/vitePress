...
str.replace(/2(?=3)/g, 6); // => '01020346321010633' [后面是]
str.replace(/(?<=3)2/g, 6); // => '01020342361010233' [前面是]
str.replace(/2(?!3)/g, 6); // => '01060342361010233' [后面不是]
str.replace(/(?<!3)2/g, 6); // => '01060346321010633' [前面不是]
~~~
